...
public class DbInitializer implements ServletContextListener {
     ...
     * @throws RuntimeException si la inicializacion falla (propaga el error para
     *                          impedir el arranque)
     */
    @Override
    ...
    /**
     * Carga un script SQL desde el classpath y lo ejecuta contra la conexion
     * indicada.
     * Se usa para crear las tablas (schema.sql) y cargar los datos de prueba
     * (data.sql).
     *
